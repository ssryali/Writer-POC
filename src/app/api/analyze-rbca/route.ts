...
const WRITER_APP_ID = "6489d658-a767-4841-88fb-9b7d3c4e1f1f";
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      agentId: "US-MKT-05",
      agentName: "Required Behavior Change Articulation",
    });
  } catch (error) {
    console.error("[ANALYZE-RBCA] Error:", error instanceof Error ? error.message : error);
    return NextResponse.json(
